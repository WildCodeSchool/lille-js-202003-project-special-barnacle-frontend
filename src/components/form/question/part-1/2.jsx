          ...
          <div className="row text-center">
            <div className="col-10 col-sm-5 col-lg-2 px-0 formCard mb-5 text-center mx-auto">
              <input
                ...
                type="image"
                alt="maison"
                src="img/form/question2/acheterunbien.png"
                width="100%"
                onClick={(e) => {
            ...
            <div className="col-10 col-sm-5 col-lg-2 px-0 formCard mb-5 text-center mx-auto">
              <input
                ...
                type="image"
                alt="Un appartement"
                src="img/form/question2/faireconstruire.png"
                width="100%"
                onClick={(e) => {
                  handleChange(e, 'question2');
                }}
            ...
            <div className="col-10 col-sm-5 col-lg-2 px-0 formCard mb-5 text-center mx-auto">
              <input
                ...
                type="image"
                alt="Un terrein seul"
                src="img/form/question2/fairedestravaux.png"
                width="100%"
                onClick={(e) => {
                  handleChange(e, 'question2');
                }}
            ...
            <div className="col-10 col-sm-5 col-lg-2 px-0 formCard mb-5 text-center mx-auto">
              <input
                ...
                type="image"
                alt="Autre"
                src="img/form/question2/renegocier.png"
                width="100%"
                onClick={(e) => {
                  handleChange(e, 'question2');
                }}
